...
def simulate_game(game_count):
    ...
    while game < game_count:
        ...
        while current_game.game_day <= 100 and current_game.game_state != "End":
            current_game.day_init()
            if current_game.hero:
                current_game.hero.action = current_game.action_to_symbol(random.randrange(5))
    ...
    while createGame:
        ...
        while new_game.game_state != "End":
            ...
            if new_game.hero:
                ...
                new_game.hero.action = hero_action
